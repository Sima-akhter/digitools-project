          ...
          <div className="bg-white p-1.5 rounded-full shadow-sm border border-gray-100 flex gap-1">
            <button
              ...
              className={`px-8 py-2.5 rounded-full font-bold transition-all ${
                activeTab === 'products' ? 'bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white shadow-lg' : 'text-[#64748B]'
              }`}
            >
              Products
            </button>
            <button
              ...
              className={`px-8 py-2.5 rounded-full font-bold transition-all ${
                activeTab === 'cart' ? 'bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white shadow-lg' : 'text-[#64748B]'
              }`}
            >
              Cart ({cart.length})
            </button>
